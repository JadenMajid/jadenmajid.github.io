...
I'm a penultimate year computer science student at UBC. I used to study physics but switched into CS in my third year.
I've taken/am taking 4 courses on machine learning/AI. 2 courses are about the math of ML(CPSC 340, 440), 1 course is about ML application(CPSC 330), and lastly a course on AI in general(CPSC 322).
...
1. A neural network in C, using only knowledge from CPSC 340
1. An implementation project for a GAN upscaling architecture model
